...
const Header = () => {
    ...
    return (
        <header className={`bg-black relative z-10 before:content-[\" \"] before:block before:bg-black before:opacity-0 ${isOpen ? "before:opacity-35  before:w-screen before:h-screen before:-z-10 before:absolute before:transition-all " : ""}`}>
            <div className='md:container bg-black relative z-10 flex items-center  px-6 py-8 justify-between md:justify-items-start border-[#979797] border-b'>
                ...
                <NavLinks links={desktopLinks} className='hidden lg:flex text-white uppercase gap-[2.125rem] text-sub-title' linkClassName=""/>
                <CartButton/>
            </div>
