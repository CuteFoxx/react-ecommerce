            ...
            <Swiper modules={[Autoplay]} autoplay={{delay: 3500, pauseOnMouseEnter: true}} slidesPerView={1} className='!overflow-visible !-mx-6 md:!-mx-0 lg:!overflow-hidden lg:max-w-[69.375rem]'>
                {
                    newProducts.map((product: Product) => (
                        <SwiperSlide key={product.id}
                            ...
                            <div className='lg:pt-[4.6875rem] flex flex-col items-center lg:items-start'>
                                ...
                                <Link className='uppercase button min-h-12 w-full max-w-40 mx-auto !p-0 flex items-center justify-center lg:mx-0' to={`/${product.category}/${product.slug}`}>See
                                    product</Link>
                            </div>
